# Convolutional Neural Network to Classify Pneumonia in Chest X-Rays 
...
Clinical Context:This project is intended for clinicians, radiologists, and healthcare researchers interested in computer-aided diagnosis tools. It addresses the challenge of efficiently identifying pneumonia from chest X-rays, a common and potentially serious respiratory condition that can be difficult to diagnose quickly and consistently. By automating the classification of X-ray images as normal or pneumonia, this model aims to support earlier detection, reduce diagnostic workload, and improve clinical decision-making, particularly in high-volume or resource-limited settings.

Roles: Ayushi Elhence created the repository and led code development and troubleshooting to train our Convolutional Neural Network and create the README.md file. Megan LeComte analyzed the code and output and wrote the introduction, results and evaluation, and discussion and limitations sections of the report. Quinn Mullings analyzed the code and output and wrote the abstract, literature review, and methods and data portions of the report. 
